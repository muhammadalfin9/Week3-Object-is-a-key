...
function shoppingTime(memberId, money) {
  ...
  if (shop.changeMoney >= 1500000) {
    dibeli.push("Sepatu Stacattu");
    shop.changeMoney -= 1500000;
  }
  if (shop.changeMoney >= 500000) {
    dibeli.push("Bajun Zoro");
    shop.changeMoney -= 500000;
  }
  if (shop.changeMoney >= 250000) {
    dibeli.push("Baju H&N");
    shop.changeMoney -= 250000;
  }
  if (shop.changeMoney >= 175000) {
    dibeli.push("Sweater Uniklooh");
    shop.changeMoney -= 175000;
  }
  if (shop.changeMoney >= 50000) {
    dibeli.push("CHARGER HP");
